...
module RAM( addr,din,RAM_mode,WE,clk,clr,lh,dout);
input [31:0] addr;
input [31:0] din;
input RAM_mode;
input WE,clk,clr,lh;
...
if(lh) begin
 case(RAM_mode)
  1'b0: begin 
           out[7:0] <= mem1[addr[21:2]];
           out[15:8]<= mem2[addr[21:2]];
           // out[31:16]<={16{mem2[addr[21]]}};
  end
  1'b1:begin
           out[7:0] <= mem3[addr[21:2]];
           out[15:8] <= mem4[addr[21:2]];
         //  out[31:16]<={16{mem4[addr[21]]}};
  end
  default: out<=0;
  endcase
  out[31:16]<={16{out[15]}};
  ...
  out[7:0] <= mem1[addr[21:2]];
  out[15:8] <= mem2[addr[21:2]];
  out[23:16] <= mem3[addr[21:2]];
  out[31:24] <= mem4[addr[21:2]];
end
end
